...
qr.image(text, { type: 'png', ec_level: ec_level, parse_url: false, size: 100}).pipe(file('qr_f.png'));
qr.image(text, { type: 'png', ec_level: ec_level, parse_url: true,  size: 500}).pipe(file('qr_t.png'));
